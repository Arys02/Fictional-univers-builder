...
# Update the get_db_connection function to point to the project root
...
def prompt_page():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # If this is a continuation of a conversation, include previous exchanges
            if (
            ...
            if request.form.get("save") == "yes":
                ...
                univers_data = ask_univers_extraction(response_content)
                print("Extracting faction data...")
                ...
                # Insert universe and get its ID
                insert_univers(univers_data)
                univers_id = get_univers_id()

                # Insert other elements with the universe ID
                insert_factions(factions_data, univers_id=univers_id)
                insert_location(locations_data, univers_id=univers_id)
                insert_cultures(cultures_data, univers_id=univers_id)
                print("Data saved successfully")

                # Redirect to wiki after saving
